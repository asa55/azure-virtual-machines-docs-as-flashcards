...
The content of the flashcards defined within the Markdow files in this repository reflects the content of the official Microsoft documentation for Azure Virtual Networks, which can be found here: [`https://learn.microsoft.com/azure/virtual-machines`](https://learn.microsoft.com/azure/virtual-machines).
